...
## 🎥 Ejemplo
![Captura del video]([assets/captura.png](https://github.com/andreajurado-data/Procesamiento_de_im-genes/blob/main/Procesamiento_de_im%C3%A1genes.png?raw=true))
